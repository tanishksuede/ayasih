...
export const STORY_METADATA_REGISTRY: Record<string, StoryMetadata> = {
    ...
    'lvl_age_17_tagore': {
        ...
        dilemmaType: 'Colonial Law Degree vs Authentic Cultural Voice',
        lifeTheme: 'risk_vs_safety',
        situationalTags: ['family_pressure', 'career_uncertainty', 'identity_question', 'big_decision', 'purpose'],
        protagonistLens: 'How Rabindranath Tagore chose to abandon his legal studies in London without a degree to return to Bengal and dedicate his life to literature and music.',
        historicalContext: 'In 1878 at age 17, sent to University College London by his family to become a barrister, he realized that true education must harmonize life with all existence, choosing literature over colonial credentials.',
        reflectionPrompt: 'Where in your life are you pursuing external validation or safe credentials at the expense of your true calling?',
        microActionPrompt: 'Identify one ambition you hold purely for social status, and ask yourself what you would create if no one was judging you.',
        difficulty: 'deep',
        targetTraits: { risk: 90, creativity: 100, vision: 100, empathy: 100, leadership: 92 },
    },
    'lvl_age_22_tagore': {
        scenarioId: 'lvl_age_22_tagore',
        dilemmaType: 'Youthful Melancholy vs Universal Empathy and Flow',
        lifeTheme: 'purpose',
        situationalTags: ['feeling_stuck', 'identity_question', 'purpose', 'creativity', 'starting_something'],
        protagonistLens: 'How Rabindranath Tagore broke free from self-absorbed sorrow through a sudden mystical morning epiphany in Kolkata, creating "The Awakening of the Waterfall".',
        historicalContext: 'In 1883 at age 22, living on Sadar Street, watching the sunrise over Kolkata ignited an overwhelming sensation of connection to universal humanity, liberating his poetic genius forever.',
        reflectionPrompt: 'Are you keeping your creative energy frozen behind self-doubt, or letting it flow outward to enrich others?',
        microActionPrompt: 'Do one act of creative expression or heartfelt kindness today without overthinking or fearing rejection.',
        difficulty: 'moderate',
        targetTraits: { risk: 92, creativity: 100, vision: 100, empathy: 100, leadership: 94 },
    },
};
