...
export const authService = {
    /**
     * Trigger Google OAuth login/signup flow via Supabase Auth.
     * Uses Supabase's backend callback (https://boxuixgyxzbxdrvlevuu.supabase.co/auth/v1/callback)
     * so Google Cloud origin restrictions do not block the user in the browser,
     * keeping the user entirely on the active domain (e.g. atyouragesih.vercel.app).
     */
